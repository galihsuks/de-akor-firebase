...
export default function Latihan11() {
    ...
    const soal = useRef([
        ...
        chordsTenan[
            angka12Acak.current +
                (itemSub[sublatihan - 1].includes("i") ? 12 : 0)
        ]
    ]);
    const jwbKeSoal = (rom, chord) => {
        ...
        let angka3Acak1 = Math.floor(Math.random() * 6) + 1;
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        fetchUpdateProgres(18, 1, true, currentUser.id);
    };
    const updateDataSub = () => {
        fetchUpdateProgres(17, sublatihan, false, currentUser.id);
        setCurrentUser((data) => ({
            ...data,
    ...
    if (page === 1)
        return (
            <div className="latihan-instruksi">
                <div>
                    <h1 style={{ color: "#0CCA98" }}>Latihan 11</h1>
                    <p style={{ fontSize: "30px", marginTop: "-10px" }}>
                        Chord Major Scale - I ii iii IV v V
                    </p>
                    <div className="pemisah" />
                    <p>
                        Pada tahap ini kamu diminta menebak akor ke-1 hingga
                        ke-6 menurut Chord Major Scale dengan referensi akor
                        ke-1 sampai ke-6 juga
                    </p>
                    <div className="pemisah" />
                    <h2>Tips</h2>
                    <p>
                        ...
                        <div className="kiri">
                            <div>
                                ...
                                <p>
                                    ...
                                    suara akor dan pilihlah akor ke-1 / ke-2 /
                                    ke-3 / ke-4 / ke-5 / ke-6 menurut Chord
                                    Major Scale berdasarkan referensi akor.
                                </p>
                            </div>
                        </div>
                        <div className="kanan">
        ...
        return (
            <div className="latihan-lulus">
                <div>
                    <h1>Latihan 11 Selesai</h1>
                    <div className="pemisah" />
                    <p>
                        Sehingga kamu sudah mampu mengenali jarak antar 2 akor
                        pada Chord Major Scale
                    </p>
                    <div className="pemisah" />
                    <p
                        style={{
