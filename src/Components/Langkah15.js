...
export default function Latihan9() {
    ...
    const [dataSubLatihan, setDataSubLatihan] = useState(
        currentUser.latihan > 15 ? 3 : currentUser.sublatihan
    );
    const [sublatihan, setSublatihan] = useState(dataSubLatihan);
    const itemSub = ["I", "IV", "V"];
    ...
    const soal = useRef([
        ...
        chordsTenan[angka12Acak.current]
    ]);
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        fetchUpdateProgres(16, 1, true, currentUser.id);
    };
    const updateDataSub = () => {
        fetchUpdateProgres(15, sublatihan, false, currentUser.id);
        setCurrentUser((data) => ({
            ...data,
    ...
    if (page === 1)
        return (
            <div className="latihan-instruksi">
                <div>
                    <h1 style={{ color: "#0CCA98" }}>Latihan 9</h1>
                    <p style={{ fontSize: "30px", marginTop: "-10px" }}>
                        Chord Major Scale - I IV V
                    </p>
                    <div className="pemisah" />
                    <p>
                        Pada tahap ini kamu diminta menebak akor ke-1 / ke-4 /
                        ke-5 menurut Chord Major Scale dengan referensi akor
                        ke-1 / ke-4 / ke-5
                    </p>
                    <div className="pemisah" />
                    <h2>Tips</h2>
                        ...
                        <div className="kiri">
                            <div>
                                ...
                                <p>
                                    ...
                                    suara akor dan pilihlah akor ke-1 / ke-4 /
                                    ke-5 menurut Chord Major Scale berdasarkan
                                    referensi akor.
                                </p>
                            </div>
                        </div>
        ...
        return (
            <div className="latihan-lulus">
                <div>
                    <h1>Latihan 9 Selesai</h1>
                    <div className="pemisah" />
                    <p>
                        Sehingga kamu sudah mampu mengenali perbedaan akor ke-1
                        / ke-4 / ke-5 dari Chord Major Scale
                    </p>
                    <div className="pemisah" />
                    <p
                        style={{
